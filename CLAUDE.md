...
1. ヒーロー — 「話しかけたら、サイトが変わった。」+ SVGスマホモック（チャットUI+音波アニメ）
2. 共感（Insight）— 3カード: 数週間待ち / 難しくて放置 / 修正に数万円
3. 仕組み（How It Works）— 3ステップ: 話しかける → AI実装 → 承認
4. 比較（Before/After）— 対照表: これまで vs SiteVibe
5. 特徴（Features）— 6カード: 7日/品質/音声更新/スマホ/SEO/承認制
6. 料金（Pricing）— 制作費段階制 + 3プラン（AI更新 月3/10/30）+ オプション + 超過注記
7. FAQ — 6問
8. CTA — 「まだ、一人で悩んでいますか？」+ バイブ音波アイコン

## デザインルール
- メインカラー: #0EA5E9（スカイブルー）/ AI専用: #06B6D4（シアン）
- CTA: #F97316（オレンジ）— 「無料診断を始める」ボタンのみ
- 背景: #FFFFFF（白）+ #F7F9FC（パステルグレー）の交互配置
